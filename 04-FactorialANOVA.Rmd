...
4. The variances in the populations are roughly equal (homogeneity of variance). Consider the result of Levene’s test H~0~: variances are equal; there is no difference in the variances among the means). 
