...
This model can account for approximately 68% of the variability in Intellect scores (*R^2^* = .68). The slope of the regression line was significantly different from zero (B = 0.73, *t*(37) = 8.96, *p* < .0001). 
